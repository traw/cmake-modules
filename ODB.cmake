...
function(odb_compile)
	...
	set(options GENERATE_QUERY GENERATE_SESSION GENERATE_SCHEMA
                GENERATE_PREPARED GENERATE_AT_ONCE)
	set(oneValueParams DB SCHEMA_FORMAT SCHEMA_NAME TABLE_PREFIX
		...
		DEFAULT_POINTER PGSQL_VERSION
		INPUT_NAME)
	set(multiValueParams HEADERS INCLUDES PROFILE)
	...
	if(PARAM_PGSQL_VERSION)
		list(APPEND ODB_ARGS --pgsql-server-version ${PARAM_PGSQL_VERSION})
	endif()
	...
	set(ODB_OUTPUT_DIRECTORY "${odb_output_directory}" PARENT_SCOPE)
endfunction()
